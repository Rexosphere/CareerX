            ...
            <div class="card-body p-6 sm:p-10">
                ...
                <div class="flex flex-wrap gap-2 mb-4">
                    @foreach($post['categories'] as $index => $category)
                        <span
                            class="badge {{ $index === 0 ? 'badge-primary' : 'badge-outline' }} badge-sm font-bold uppercase">
                            {{ $category }}
                        </span>
                    @endforeach
                </div>
                ...
                <div class="flex items-center justify-between border-b border-base-300 pb-6 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-base-content/70 text-xs">{{ $post['author']['title'] }} •
                ...
                <div class="mt-12 pt-8 border-t border-base-300">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex gap-4">
                            <button x-data="{ liked: false, count: {{ $post['likes'] }} }"
                                @click="liked = !liked; count = liked ? count + 1 : count - 1"
                                :class="liked ? 'text-primary' : ''" class="btn btn-ghost btn-sm gap-2">
                                <x-icon x-show="!liked" name="o-hand-thumb-up" class="w-5 h-5" />
                                <x-icon x-show="liked" x-cloak name="s-hand-thumb-up" class="w-5 h-5" />
                                <span class="font-medium" x-text="count + ' Likes'"></span>
                            </button>
                            <a href="#comments" class="btn btn-ghost btn-sm gap-2">
                ...
                @foreach($relatedPosts as $related)
                    <div class="card bg-base-100 border border-base-300 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div class="card-body p-5">
                            <span
                                class="badge badge-primary badge-sm font-semibold uppercase">{{ $related['category'] }}</span>
